...
namespace WebApplication2.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        public IActionResult GetToken()
        {
            ...
            var token = new JwtSecurityToken(_configuration["Jwt:Issuer"], _configuration["Jwt:Audience"], claims, expires: DateTime.Now.AddMinutes(1), signingCredentials: signIn);
